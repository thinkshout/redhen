...
/**
 * @file
 * Contains \Drupal\redhen_relation\RelationHtmlRouteProvider.
 */
...
class RelationHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'view Relation entities')
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\redhen_relation\Controller\RelationAddController::addForm',
          '_title_callback' => 'Drupal\redhen_relation\Controller\RelationAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\redhen_relation\Controller\RelationAddController::add',
