...
* When viewing a contact entity, you can optionally associate that contact entity with a Drupal user account. To do so, click the "Drupal User" tab, and either select an existing Drupal account or create a new one.
