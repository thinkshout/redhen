...
/**
 * Provides routes for Org entities.
 *
 * @see Drupal\Core\Entity\Routing\AdminHtmlRouteProvider
 * @see Drupal\Core\Entity\Routing\DefaultHtmlRouteProvider
 */
class OrgHtmlRouteProvider extends AdminHtmlRouteProvider {
  /**
   * {@inheritdoc}
   */
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\redhen_org\Controller\OrgAddController::addForm',
          '_title_callback' => 'Drupal\redhen_org\Controller\OrgAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\redhen_org\Controller\OrgAddController::add',
