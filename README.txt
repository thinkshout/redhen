...
RedHen CRM is similar to [Drupal Commerce][3] in its module structure. As with Drupal Commerce, the core RedHen modules that can be downloaded at http://drupal.org/project/redhen won't provide you with a working CRM right out of the box. They require configuration. In the future, ThinkShout is likely to release RedHen "Features" or "Apps" that provide pre-packaged CRM solutions for different use cases.
